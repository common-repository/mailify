...
class Sarbacane {
	...
	public static function activation() {
		...
		update_option( 'sarbacane_news_registration_button', __( 'Inscription', 'mailify' ) );
	...
	private function sarbacane_params_saved() {
		return '<div class="updated">' . __( 'A new key has been generated', 'mailify' ) . '</div>';
	}
